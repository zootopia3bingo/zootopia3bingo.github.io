...
var PHRASE_LIST = [
    ...
    "It's called a <i>something</i>, sweetheart",
    "<i>The Hustle</i> by Van&nbsp;McCoy",
    "<i>Shut Up And Dance</i> by Walk The Moon",
    ...
    "Anthropo&shy;morphized <i>Rio</i> characters",
    "Anthropo&shy;morphized <i>Ice&nbsp;Age</i> characters",
    "<i>G.O.A.T.</i> reference",
    "<i>KPDH</i> reference",
    "Weaselton, somehow",
    "Nick has a new tie and shirt",
    "Rabbit Season! Duck Season!",
    "<i>Cow and Chicken</i> reference",
