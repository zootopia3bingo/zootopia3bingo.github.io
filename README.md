...
var PHRASE_LIST = [
    ...
    "It's called a <em>something</em>, sweetheart",
    "<em>The Hustle</em> by Van&nbsp;McCoy",
    "<em>Shut Up And Dance</em> by Walk The Moon",
    ...
    "Anthropo&shy;morphized <em>Rio</em> characters",
    "Anthropo&shy;morphized <em>Ice&nbsp;Age</em> characters",
    "<em>G.O.A.T.</em> reference",
    "<em>KPDH</em> reference",
    "Weaselton, somehow",
    "Nick has a new tie and shirt",
    "Rabbit Season! Duck Season!",
    "<em>Cow and Chicken</em> reference",
